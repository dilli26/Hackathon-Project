...
public class Tc_003_007_UI_ValidatingLoanAmountcalculator_InterestRate extends DriverSetup{
	@Test(priority=9)
	public void validatingLoanAmountcalculator_InterestRate()
	{
		l.info("validating LoanAmount calculator InterestRate");
