...
public class Tc_003_013_UI_ValidatingLoanTenturecalculator_InterestRate extends DriverSetup{
	@Test(priority=15)
	public void validatingLoanTenturecalculator_InterestRate()
	{
		l.info("validating LoanTenture calculator InterestRate");
